...
namespace Hive.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountManager UserManager
        {
            get
            {
                return userManager ?? HttpContext.GetOwinContext().GetUserManager<AccountManager>();
            }
            private set
            {
                userManager = value;
       ...
       [AllowAnonymous]
       [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterVM model, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                model.User.UserName = model.Username;
                model.User.JoinedDate = DateTime.Now;
                ...
                if (result.Succeeded)
                {
                    SignIn(model.User, isPersistent: true);
